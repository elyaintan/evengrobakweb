    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">Grafik Pengguna</h2>
                        <p class="lead">Grafik ini diambil dari banyaknya jumlah pengguna yang memakai aplikasi EvenGroBak.</p>
                    </div>
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Grafik Pengguna </h3>
                            </div>
